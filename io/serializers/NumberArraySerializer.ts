...
/*--------------------------------------------------------*\
|                                                          |
| hprose/io/serializers/NumberArraySerializer.ts           |
|                                                          |
| hprose number array serializer for TypeScript.           |
|                                                          |
...
export default class NumberArraySerializer extends ReferenceSerializer<ArrayLike<number>> {
