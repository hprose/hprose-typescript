...
| hprose.wx.ts                                             |
|                                                          |
| hprose on weixin application for TypeScript.             |
|                                                          |
...
export { HttpTransport, HttpClient, HttpClientContext } from './rpc/wx/HttpClient';
export { WebSocketTransport, WebSocketClient } from './rpc/wx/WebSocketClient';